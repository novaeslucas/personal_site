    ...
    <footer className="max-w-5xl mx-auto px-6 border-t border-border pt-8 pb-8">
      <div className="flex flex-col items-center">
        ...
        <div className="flex space-x-8 mb-6">
          <a
            href="https://github.com/novaeslucas"
            className="text-muted-foreground hover:text-primary transition-all transform hover:-translate-y-1 duration-300"
            aria-label="GitHub"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/novaeslucas"
            className="text-muted-foreground hover:text-primary transition-all transform hover:-translate-y-1 duration-300"
            aria-label="LinkedIn"
            target="_blank"
            rel="noopener noreferrer"
